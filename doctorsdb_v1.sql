...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=757913434ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=doctorsdb&table=guestbook">`doctorsdb`.`guestbook`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=doctorsdb&table=doctorslist">`doctorsdb`.`doctorslist`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=doctorsdb&table=adminlog">`doctorsdb`.`adminlog`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=doctorsdb&table=login">`doctorsdb`.`login`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5b27502f766d7d2562797c462f6f5c38">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="doctorsdb" targettable="doctorslist">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `doctorslist`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="doctorsdb" targettable="guestbook">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `guestbook`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="doctorsdb" targettable="login">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE guestbook
ADD assigned_to VARCHAR(255);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="doctorsdb" targettable="guestbook">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE guestbook
ADD department VARCHAR(255) NOT NULL;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="doctorsdb" targettable="guestbook">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE doctorslist
ADD department VARCHAR(255) NOT NULL;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="doctorsdb" targettable="doctorslist">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `doctorslist`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="doctorsdb" targettable="adminlog">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `adminlog`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="doctorsdb" targettable="doctorslist">
                            <div class="action_content">
